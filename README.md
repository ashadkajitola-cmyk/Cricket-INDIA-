...
<body class="bg-slate-100 font-sans text-gray-800">
    ...
    <div class="container mx-auto p-4 max-w-5xl">
        ...
        <div id="dashboard-section" class="hidden-section">
            ...
            <div class="flex flex-wrap gap-2 mb-6 border-b pb-2">
                ...
                <!-- Admin button is always visible now -->
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-600">
                    ...
                    <div class="border-b pb-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm">Match Date & Time:</label>
                            ...
                            <div>
                                <label class="block text-sm">Team 1 & Score / Overs:</label>
                                <input type="text" id="admin-team1" placeholder="Team 1 Name" class="w-full p-2 border rounded mb-2">
                                <input type="text" id="admin-score1" placeholder="Score (e.g. 150/4 in 20 ov)" class="w-full p-2 border rounded">
                            </div>
                            <div>
                                <label class="block text-sm">Team 2 & Score / Overs:</label>
                                <input type="text" id="admin-team2" placeholder="Team 2 Name" class="w-full p-2 border rounded mb-2">
                                <input type="text" id="admin-score2" placeholder="Score (e.g. 145/8 in 20 ov)" class="w-full p-2 border rounded">
                            </div>
    ...
    <!-- JavaScript Logic -->
    <script>
        const DB_KEY = "cricket_portal_db_v3";
            ...
            db.matches.forEach((m, idx) => {
                ...
                html += `
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                        <span class="text-xs bg-emerald-100 text-emerald-800 font-bold px-2 py-1 rounded">${m.seriesName} (${m.groupName})</span>
                        <div class="flex justify-between items-center mt-3">
                            <div class="text-lg font-bold">${m.team1}: <span class="text-emerald-600">${m.score1}</span> vs ${m.team2}: <span class="text-emerald-600">${m.score2}</span></div>
